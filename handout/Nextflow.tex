...
\begin{itemize}
 ...
 \item Use variables pointing to emitted items within processes' script block
\end{itemize}
...
While developing a workflow we tend to prefer to only use a mall subset of data. 
...
\begin{questions}
How can you set the value of the \texttt{task.cpus} variable? Hint look into \emph{process directives}.
\begin{answer}
\begin{lstlisting}
process fastqc {
  cpus 2
